...
insert into perfil values(1,now(),'Permisos para ver, crear, actualizar y eliminar perfiles y usuarios','ADMINISTRADOR',now(),1);
insert into perfil values(2,now(),'Permisos para ver los usuarios y perfiles pudiendo descargar la informacion en formato pdf','AUDITOR',now(),1);
